...
rounds = {
    ...
    16: [['Brisbane Lions', 'Melbourne'], ['Geelong Cats', 'Essendon'], ['Gold Coast Suns', 'Collingwood'], ['North Melbourne', 'Western Bulldogs'], ['Richmond', 'Carlton'], ['St Kilda', 'Port Adelaide'], ['Sydney Swans', 'Fremantle'], ['West Coast Eagles', 'Hawthorn']],
    17: [['Brisbane Lions', 'Adelaide Crows'], ['Collingwood', 'Essendon'], ['Geelong Cats', 'Hawthorn'], ['GWS Giants', 'Carlton'], ['Melbourne', 'West Coast Eagles'], ['North Melbourne', 'Gold Coast Suns'], ['St Kilda', 'Sydney Swans'], ['Port Adelaide', 'Western Bulldogs']],
    18: [['Collingwood', 'Geelong Cats'], ['Gold Coast Suns', 'Port Adelaide'], ['Hawthorn', 'Fremantle'], ['Melbourne', 'Essendon'], ['Richmond', 'GWS Giants'], ['North Melbourne', 'Sydney Swans'], ['St Kilda', 'West Coast Eagles'], ['Western Bulldogs', 'Carlton']],
